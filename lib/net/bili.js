...
const bili_client = {
    ...
    _getOneDynamicByDyid: new Line('获取一个动态的细节', [
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V110,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V111,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V112,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V113,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V114,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V115,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V116,
            config: { retry: false },
            query: {
                dynamic_id
            }
